...
# Package, creates build/lib/data-showcase-1.0.2.war
./gradlew assemble

# Run the war
java -jar build/libs/data-showcase-1.0.2.war
```
...
./gradlew publish
```
This publishes the artifact `nl.thehyve:data-showcase:1.0.2:war`.
...
java -jar ${JAVA_OPTIONS} ${MEMORY_OPTIONS} ${APP_OPTIONS} data-showcase-1.0.2.war
```
